...
- Focus: behavior tracking and visualization
- Tech: React, Vite, JavaScript, localStorage
- Live demo: https://walking-behavior-tracker.vercel.app
...
- Focus: contextual signals, walking adherence, simulated data
- Tech: Python, pandas, numpy
- Repository: https://github.com/Yeongseo-Lee/02.walking-adherence-prediction
...
- Focus: behavior intervention design, transparent logic, digital health
- Tech: React, Vite, JavaScript
- Repository: https://github.com/Yeongseo-Lee/03.AI-behavior-intervention-designer
...
- Focus: responsible AI, safety evaluation, healthcare AI
- Tech: Python, pandas, numpy
- Repository: https://github.com/Yeongseo-Lee/04.AI-health-suggestion-evaluation
...
- Focus: adaptive prompt timing, personalization, JITAI, behavior change
- Tech: React, Vite, JavaScript, localStorage
- Repository: https://github.com/Yeongseo-Lee/adaptive-micro-action-trigger-engine
